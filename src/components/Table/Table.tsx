...
export const Table = () => {
  ...
  return (
    <main className={s.main}>
        ...
        <table>
          ...
          <tbody>
            {filteredUsers.length ? (
              ...
              <tr>
                <td colSpan={2} className={s.not_found}>
                  Sorry, nothing found...
                </td>
                <td colSpan={2} className={s.not_found}>
                  <button onClick={handleClearFilters} className={s.btn_remove}>
      ...
      {isModalOpen && <ModalWindow user={selectedUser} onClose={closeModal}/>}
    </main>
  );
};
